...
class CBTaggingDecoder:
    ...
    def dp(self):
        ...
        self.result = {}
        self.alphas = []
        self.bestScore = alp.dbDecode(self.model.l_size, self.model.ll_weights, self.len, self.nodes, self.values,
                                      self.alphas, self.result, self.labelTransPre, self.allowedLabelLists)
